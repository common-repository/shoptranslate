...
$content_word 	= !empty( $content ) ? str_word_count( strip_tags( $content ) ) : 0;
$title_word 	= !empty( $post_title ) ? str_word_count( strip_tags( $post_title ) ) : 0;
...
<!-- SEO Translate Popup -->
<div id="wwt-tran-seo-pro-modal" class="wwt-tran-modal">
	<div class="wwt-tran-modal-content">
		...
		<div class="wwt-tran-modal-body">
			...
			<p><input type="hidden" name="wwt-tran-post-id" id="wwt-tran-post-id" value="<?php echo $post_id; ?>"></p>
			
			
			<p><input type="hidden" name="wwt-tran-seo-type" id="wwt-tran-seo-type" value="seo"></p>
			<p> 
				<a href="javascript:void(0)" class="wwt-tran-send-seo-pro-btn wwt-tran-btn"><?php _e( 'Send Your Inquiry', WWT_TRAN_TEXT_DOMAIN );?></a>
